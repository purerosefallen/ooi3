...
def main():
    ...
    app.router.add_route('GET', '/kcs/resources/world/{server:.+}_{size:[lst]}.png', api.world_image)
    app.router.add_route('GET', '/kcs2/resources/image/world/{server:.+}_{size:[lst]}.png', api.world_image)
    app.router.add_route('GET', '/kcs2/resources/world/{server:.+}_{size:[lst]}.png', api.world_image)
